...
(function(window, $){
  ...
  $.extend($.animations, {
    ...
    vanishIn: '0% { opacity: 0; {browser}transform-origin: 50% 50%; {browser}transform: scale(2, 2); {browser}filter: blur(90px); } 100% { opacity: 1; {browser}transform-origin: 50% 50%; {browser}transform: scale(1, 1); {browser}filter: blur(0px); }',
